...
public class Material {
  ...
  /**
   * Constructor. Sets the ambient, diffuse, specular, emission and shininess
   * values
   * 
   * @param ambient   vector of 3 values: red, green and blue, in the range
   *                  0.0..1.0.
   * @param diffuse   vector of 3 values: red, green and blue, in the range
   *                  0.0..1.0.
   * @param specular  vector of 3 values: red, green and blue, in the range
   *                  0.0..1.0.
   * @param emission  vector of 3 values: red, green and blue, in the range
   *                  0.0..1.0.
   ...
   * Sets the ambient value (as used in Phong local reflection model)
   * 
   * @param rgb vector of 3 values, where the 3 values are the values for red,
   *            green and blue,
   ...
   * 
   * @return vector of 3 values, where the 3 values are the values for red, green
   *         and blue.
   */
   ...
   * Sets the specular value (as used in Phong local reflection model)
   * 
   * @param rgb vector of 3 values, where the first 3 values are the values for
   *            red, green and blue,
   *            in the range 0.0..1.0, and the last value is an alpha term, which
   *            is always 1.
   */
